...
export class GraphDataService {
    ...
    createInfluenceRelation(sourceId: number, cibleId: number): Observable<CreationRelationResponse | null> {
        ...
        return this.http.post<{
            success: boolean;
            data: CreationRelationResponse
        }>(`${this.apiUrl}/oeuvres/influence`, request).pipe(
            map(response => response.data),
            catchError(error => {
    ...
    getOeuvresByArtiste(artisteId: number): Observable<OeuvreWithArtiste[]> {
        return this.http.get<{
            success: boolean;
            data: OeuvreWithArtiste[]
        }>(`${this.apiUrl}/artistes/${artisteId}/oeuvres`).pipe(
            map(response => response.data),
            catchError(error => {
    ...
    createCreationRelation(artisteId: number, oeuvreId: number): Observable<CreationRelationResponse | null> {
        ...
        return this.http.post<{
            success: boolean;
            data: CreationRelationResponse
        }>(`${this.apiUrl}/artistes/creation`, data).pipe(
            map(response => response.data),
            catchError(error => {
